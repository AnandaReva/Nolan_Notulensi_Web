...
document.addEventListener("click", function (e) {
    if (e.target && e.target.className == "addAction") {
        ...
        actionDiv.innerHTML = `
            <table class="table"> 
                <tr>
                    index discussion = ${discussionIndex} index action = ${actionIndex}
                </tr>
                <tr>
                    <td>
...
document.addEventListener("click", function (e) {
    if (e.target && e.target.className == "addActionNew") {
        ...
        actionDiv.innerHTML = ` discussion index: ${discussionIndex} action index: ${newActionIndex}
