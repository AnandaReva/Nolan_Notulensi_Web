...
Route::group(['prefix' => 'nolan.com', 'middleware' => ['auth', 'checkLogin']], function () {
    ...
    Route::get('/add/{idLogin}', [MeetingController::class, 'add'])->name('meeting.add');
    Route::post('/meeting/{idLogin}', [MeetingController::class, 'store'])->name('meeting.store');

    Route::get('/meeting/{id}/edit/{idLogin}', [MeetingController::class, 'edit'])->name('meeting.edit');
    Route::put('/meeting/{id}/update{idLogin}', [MeetingController::class, 'update'])->name('meeting.update');
